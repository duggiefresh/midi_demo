...
# This allows us a shortcut to writing a length of notes quickly and efficiently
...
chord = Instrument.new C[:middle]
melod = Instrument.new C[5]

chord.add  R.e,  [G, B, D].e, R.e, [G, B, D].e, R.e,  [G, B, D].e, [G, D, G[4]].e
melod.add [B, D, E, Fs, B, D, D, G, G[1], G[1], B[1], Fs[1], G[1]].map(&:e)
